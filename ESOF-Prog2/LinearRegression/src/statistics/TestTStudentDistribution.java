...
public class TestTStudentDistribution  extends TestCase {
	...
	public void testCase1(){
		...
		assertEquals(-22.55, r.RoundValue(r.CalcB0(), 2));
		assertEquals(1.728, r.RoundValue(r.CalcB1(), 3));
		assertEquals(644.4, r.RoundValue(r.CalcYk((double) 386), 1));
		
		assertEquals(0.9545, r.RoundValue(r.CalcR(), 4));
	...
	public void testCase2(){
		...
		LinearRegression r = new LinearRegression(number_list);
		assertEquals(-4.0389, r.RoundValue(r.CalcB0(), 4));
		assertEquals(0.1681, r.RoundValue(r.CalcB1(), 4));
		assertEquals(60.86, r.RoundValue(r.CalcYk((double) 386), 2));
